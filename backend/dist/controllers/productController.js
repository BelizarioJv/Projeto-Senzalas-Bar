...
import { ProductRequestSchema, UpdateProductRequestSchema, MetaProductRequestSchema, } from "./schemas/ProductRequestSchema.js";
...
export class ProductController {
    ...
    getProductsLowStock = async (req, res, next) => {
        try {
